      ...
      <div class="row">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">ATI</li>
          </ol>
        </nav>
      </div>
      <div class="row">
...
// var API_IP = "http://168.176.27.75:10000"
  ...
  mounted () {
    ...
    .then(response => {
      for(var k in response.data.data){
        if (response.data.data[k].tipo_solicitud.nombre == "ATI") {
          var request = {}
          ...
          request["url"] = "/ati/"+response.data.data[k]._id;
